...
public class SandboxListas
{
    ...
    public List<Integer> getCopiaEnteros( )
    {
    	...
    	List<Integer> newlist = new ArrayList<>(listaEnteros);
    ...
    public List<String> getCopiaCadenas( )
    {
    	...
    	List<String> newlist = new LinkedList<>(listaCadenas);
    ...
    public void eliminarEntero( int valor )
    {
    	...
    	for(int i=0; i<listaEnteros.size(); i++) {
    		...
    		newlist.add(listaEnteros.get(i));
    		}
    	}
    ...
    public void eliminarCadena( String cadena )
    {
		...
		while ( i < listaCadenas.size()) {
    		if(!listaCadenas.get(i).equals(cadena)) {
        		newlist.add(listaCadenas.get(i));
    ...
    public void volverPositivos( )
    {
    	...
    	for(int i=0; i<listaEnteros.size(); i++) {
    		if(listaEnteros.get(i) < 0) {
    			int newva = -listaEnteros.get(i);
    			listaEnteros.set(i,newva);
    		}
    	}
    ...
    public int contarEnterosRepetidos( )
    {
    	...
    	while (i<listaEnteros.size()) {
    		...
    		if(!list.contains(num) && Collections.frequency(listaEnteros, num) >= 2) {
    			count++;
    			list.add(num);
    		}
    		i++;
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
    	...
    	for(int i=0; i<cantidad; i++) {
    		list.add(minimo + (int) (Math.random()*rn));
    	}
