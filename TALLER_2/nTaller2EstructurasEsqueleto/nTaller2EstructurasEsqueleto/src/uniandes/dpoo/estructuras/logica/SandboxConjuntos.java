...
public class SandboxConjuntos
{
    ...
    public List<String> getCadenasComoLista( )
    {
    	...
    	List<String> lista = new java.util.ArrayList<>(arbolCadenas);
    	return  lista;
    ...
    public List<String> getCadenasComoListaInvertida( )
    {
    	...
    	List<String> lista = new java.util.ArrayList<>(arbolCadenas.descendingSet());
    	return  lista;
    }
    ...
    public String getUltima( )
    {
    	...
    	if(arbolCadenas.size()== 0) {
    		...
    		result = arbolCadenas.descendingSet().first();
    	}
    ...
    {
    	Collection<String> conjunto = new TreeSet<>();
    	
    	conjunto = arbolCadenas.tailSet(cadena);
    ...
    {
    	NavigableSet<String> NuevaCadena = new TreeSet<>(arbolCadenas);
    	
    	for(int i=0; i<arbolCadenas.size(); i++) {
    		
    		String text = NuevaCadena.first();
    		
    		if(text.toLowerCase().equals(cadena.toLowerCase())) {
    			
    			arbolCadenas.remove(text);
    			
    		}
    		
    		NuevaCadena.remove(text);
    	}
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
    	...
    	NavigableSet<String> NuevaCadena = new TreeSet<>();
    	
    	for(int i=0; i<objetos.size(); i++) {
    		
    		NuevaCadena.add(objetos.get(i).toString());
    		
    		
    	}
    	
    	arbolCadenas = NuevaCadena;
    ...
    public TreeSet<String> invertirCadenas( )
    {
    	...
    	TreeSet<String> tree = new TreeSet<>(arbolCadenas.descendingSet());
